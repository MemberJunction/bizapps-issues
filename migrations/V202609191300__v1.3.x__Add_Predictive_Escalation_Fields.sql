-- BizAppsIssues: Add Predictive Escalation Outcome Columns & Engineered View Features
-- Materialized columns for Predictive Studio issue escalation classification and operational sorting/filtering.
...
---------------------------------------------------------------------------
ALTER TABLE ${flyway:defaultSchema}.[Issue] ADD
...
ALTER TABLE ${flyway:defaultSchema}.[Issue] ADD CONSTRAINT [CK_Issue_PredictedEscalationRiskBand]
...
---------------------------------------------------------------------------
-- 2. Update vwIssues: include engineered relational & temporal training features
---------------------------------------------------------------------------
UPDATE [${mjSchema}].[Entity]
SET [BaseViewGenerated] = 0
WHERE [ID] = '65E7DAD5-9930-4140-9A38-2184EB0097DA';
GO
...
SELECT
    ...
    CASE 
        WHEN (SELECT COUNT(*) FROM [${flyway:defaultSchema}].[IssueComment] c WHERE c.[IssueID] = i.[ID]) >= 3 THEN 'Escalated' 
        ELSE 'Standard' 
    END AS [IsCriticalEscalation],
    ISNULL((SELECT COUNT(*) FROM [${flyway:defaultSchema}].[IssueComment] c WHERE c.[IssueID] = i.[ID]), 0) AS [CommentsCount],
    CASE WHEN i.[AssigneeRecordID] IS NOT NULL THEN 1 ELSE 0 END AS [HasAssignee],
    ISNULL(LEN(i.[Title]), 0) AS [TitleLength],
    ISNULL(LEN(i.[Description]), 0) AS [DescriptionLength]
FROM
...
/* SQL text to insert 8 new entity field(s) */
      ...
      IF NOT EXISTS (SELECT 1 FROM [${mjSchema}].[EntityField] WHERE ID = 'e3da291a-9919-4fbd-b2ac-453baebfb788' OR (EntityID = '65E7DAD5-9930-4140-9A38-2184EB0097DA' AND Name = 'PredictedCriticalEscalationProbability')) BEGIN
         ...
         (
            ...
            (SELECT COALESCE(MAX([Sequence]), 0) + 1 FROM [${mjSchema}].[EntityField] WHERE [EntityID] = '65E7DAD5-9930-4140-9A38-2184EB0097DA'),
      ...
      IF NOT EXISTS (SELECT 1 FROM [${mjSchema}].[EntityField] WHERE ID = '5bdfcefb-787b-49dc-8508-8d3e2cc9ade3' OR (EntityID = '65E7DAD5-9930-4140-9A38-2184EB0097DA' AND Name = 'PredictedEscalationRiskBand')) BEGIN
         INSERT INTO [${mjSchema}].[EntityField]
         (
            [ID],
            [EntityID],
      ...
      IF NOT EXISTS (SELECT 1 FROM [${mjSchema}].[EntityField] WHERE ID = 'f1263060-2773-46bb-b829-460e777e4d3a' OR (EntityID = '65E7DAD5-9930-4140-9A38-2184EB0097DA' AND Name = 'PredictedEscalationScoredAt')) BEGIN
         INSERT INTO [${mjSchema}].[EntityField]
         (
            [ID],
            [EntityID],
      ...
      IF NOT EXISTS (SELECT 1 FROM [${mjSchema}].[EntityField] WHERE ID = '228da02b-55f1-4de0-824f-dc74320e737b' OR (EntityID = '65E7DAD5-9930-4140-9A38-2184EB0097DA' AND Name = 'IsCriticalEscalation')) BEGIN
         INSERT INTO [${mjSchema}].[EntityField]
         (
            [ID],
            [EntityID],
      ...
      IF NOT EXISTS (SELECT 1 FROM [${mjSchema}].[EntityField] WHERE ID = '6361dba4-094e-4055-94a4-bd74cdbe4487' OR (EntityID = '65E7DAD5-9930-4140-9A38-2184EB0097DA' AND Name = 'CommentsCount')) BEGIN
         INSERT INTO [${mjSchema}].[EntityField]
         (
            [ID],
            [EntityID],
      ...
      IF NOT EXISTS (SELECT 1 FROM [${mjSchema}].[EntityField] WHERE ID = 'b64ccbdf-1742-4c34-a63d-07da4ef151b5' OR (EntityID = '65E7DAD5-9930-4140-9A38-2184EB0097DA' AND Name = 'HasAssignee')) BEGIN
         INSERT INTO [${mjSchema}].[EntityField]
         (
            [ID],
            [EntityID],
      ...
      IF NOT EXISTS (SELECT 1 FROM [${mjSchema}].[EntityField] WHERE ID = '153fbaf4-8251-4f52-bf87-f6e1aedf98df' OR (EntityID = '65E7DAD5-9930-4140-9A38-2184EB0097DA' AND Name = 'TitleLength')) BEGIN
         INSERT INTO [${mjSchema}].[EntityField]
         (
            [ID],
            [EntityID],
      ...
      IF NOT EXISTS (SELECT 1 FROM [${mjSchema}].[EntityField] WHERE ID = 'a0aace31-0601-457a-b4d1-d87a27c6f47d' OR (EntityID = '65E7DAD5-9930-4140-9A38-2184EB0097DA' AND Name = 'DescriptionLength')) BEGIN
         INSERT INTO [${mjSchema}].[EntityField]
         (
            [ID],
            [EntityID],
...
EXEC [${mjSchema}].[spDeleteUnneededEntityFields] @ExcludedSchemaNames='', @EntityIDs='65E7DAD5-9930-4140-9A38-2184EB0097DA', @IncludedSchemaNames='${flyway:defaultSchema}';

/* SQL text to update existing entity fields from schema (1 scoped entities) */
EXEC [${mjSchema}].[spUpdateExistingEntityFieldsFromSchema] @ExcludedSchemaNames='', @EntityIDs='65E7DAD5-9930-4140-9A38-2184EB0097DA', @IncludedSchemaNames='${flyway:defaultSchema}';
...
IF NOT EXISTS (
      SELECT 1 FROM [${mjSchema}].[EntitySetting] WHERE [EntityID] = '65E7DAD5-9930-4140-9A38-2184EB0097DA' AND [Name] = 'FieldCategoryInfo'
   )
   BEGIN
      INSERT INTO [${mjSchema}].[EntitySetting] ([ID], [EntityID], [Name], [Value], [__mj_CreatedAt], [__mj_UpdatedAt])
               VALUES ('3c710b93-00ae-5f44-9f14-d91e4e4ededf', '65E7DAD5-9930-4140-9A38-2184EB0097DA', 'FieldCategoryInfo', '{
  "Classification": {
...
IF NOT EXISTS (
      SELECT 1 FROM [${mjSchema}].[EntitySetting] WHERE [EntityID] = '65E7DAD5-9930-4140-9A38-2184EB0097DA' AND [Name] = 'FieldCategoryIcons'
   )
   BEGIN
      INSERT INTO [${mjSchema}].[EntitySetting] ([ID], [EntityID], [Name], [Value], [__mj_CreatedAt], [__mj_UpdatedAt])
               VALUES ('be0c082c-2519-577a-b073-31c764d4aade', '65E7DAD5-9930-4140-9A38-2184EB0097DA', 'FieldCategoryIcons', '{
...
IF NOT EXISTS (
      SELECT 1 FROM [${mjSchema}].[GeneratedCode] WHERE [CategoryID] = (SELECT [ID] FROM [${mjSchema}].[vwGeneratedCodeCategories] WHERE [Name]='CodeGen: Validators') AND [LinkedEntityID] = 'E0238F34-2837-EF11-86D4-6045BDEE16E6' AND [LinkedRecordPrimaryKey] = '65E7DAD5-9930-4140-9A38-2184EB0097DA'
   )
   BEGIN
      INSERT INTO [${mjSchema}].[GeneratedCode] ([ID], [CategoryID], [GeneratedByModelID], [GeneratedAt], [Language], [Status], [Source], [Code], [Description], [Name], [LinkedEntityID], [LinkedRecordPrimaryKey])
...
}', 'Both Assignee Entity and Assignee Record must either be provided together or both left blank to ensure the assignee reference is complete.', 'ValidateAssigneeFieldsCoexistence', 'E0238F34-2837-EF11-86D4-6045BDEE16E6', '65E7DAD5-9930-4140-9A38-2184EB0097DA')
   END;
...
VALUES ('4020813c-2edb-49f2-ab51-4d3a7f9dc661', (SELECT [ID] FROM [${mjSchema}].[vwGeneratedCodeCategories] WHERE [Name]='CodeGen: Validators'), 'C43229F6-4CC8-4838-9D04-03419A2DA191', GETUTCDATE(), 'TypeScript', 'Approved', '([SourceEntityID] IS NULL AND [SourceRecordID] IS NULL OR [SourceEntityID] IS NOT NULL AND [SourceRecordID] IS NOT NULL)', '	public ValidateSourceEntityAndRecordCoexistence(result: ValidationResult) {
	...
	}', 'Both Source Entity and Source Record must be provided together, or both must be left empty.', 'ValidateSourceEntityAndRecordCoexistence', 'E0238F34-2837-EF11-86D4-6045BDEE16E6', '65E7DAD5-9930-4140-9A38-2184EB0097DA')
   END;
