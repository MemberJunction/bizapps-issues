...
// Import supplemental manifests for BizApps Issues + its dependency apps.
// This test-harness Explorer loads Issues, Tasks, and Common client bootstraps
// so FK'd Person/Task records render with their proper forms.
import {CLASS_REGISTRATIONS as ISSUES_CLASSES} from '@mj-biz-apps/issues-ng';
import {CLASS_REGISTRATIONS as TASKS_CLASSES} from '@mj-biz-apps/tasks-ng';
import {CLASS_REGISTRATIONS as COMMON_CLASSES} from '@mj-biz-apps/common-ng';

// static code path builder
const combinedClasses = [...CLASS_REGISTRATIONS, ...ISSUES_CLASSES, ...TASKS_CLASSES, ...COMMON_CLASSES];
