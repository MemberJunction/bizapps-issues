...
export const mjBizAppsIssuesIssueSchema = z.object({
    ...
    *   * Medium
    ...
    __mj_UpdatedAt: z.date().describe(`
        ...
        * * SQL Data Type: datetimeoffset
        * * Default Value: getutcdate()`),
    PredictedCriticalEscalationProbability: z.number().nullable().describe(`
        * * Field Name: PredictedCriticalEscalationProbability
        * * Display Name: Escalation Probability
        * * SQL Data Type: decimal(5, 4)
        * * Description: Predicted probability (0.0000 - 1.0000) that this issue escalates to critical or high back-and-forth severity.`),
    PredictedEscalationRiskBand: z.union([z.literal('Critical'), z.literal('High'), z.literal('Low'), z.literal('Medium')]).nullable().describe(`
        * * Field Name: PredictedEscalationRiskBand
        * * Display Name: Escalation Risk Band
        * * SQL Data Type: nvarchar(20)
    * * Value List Type: List
    * * Possible Values 
    *   * Critical
    ...
    *   * Low
    *   * Medium
        * * Description: Operational escalation risk tier: Low (<0.30), Medium (0.30-0.70), High (>0.70), or Critical (>=0.90).`),
    PredictedEscalationScoredAt: z.date().nullable().describe(`
        * * Field Name: PredictedEscalationScoredAt
        * * Display Name: Escalation Scored At
        * * SQL Data Type: datetimeoffset
        * * Description: Timestamp when this issue was last scored by the predictive escalation model.`),
    ...
    CreatedByPerson: z.string().nullable().describe(`
        ...
        * * SQL Data Type: nvarchar(201)`),
    IsCriticalEscalation: z.string().describe(`
        * * Field Name: IsCriticalEscalation
        * * Display Name: Is Critical Escalation
        * * SQL Data Type: varchar(9)`),
    CommentsCount: z.number().describe(`
        * * Field Name: CommentsCount
        * * Display Name: Comments Count
        * * SQL Data Type: int`),
    HasAssignee: z.number().describe(`
        * * Field Name: HasAssignee
        * * Display Name: Has Assignee
        * * SQL Data Type: int`),
    TitleLength: z.number().describe(`
        * * Field Name: TitleLength
        * * Display Name: Title Length
        * * SQL Data Type: int`),
    DescriptionLength: z.number().describe(`
        * * Field Name: DescriptionLength
        * * Display Name: Description Length
...
export class mjBizAppsIssuesIssueNumberSequenceEntity extends BaseEntity<mjBizAppsIssuesIssueNumberSequenceEntityType> {
    ...
    */
    ...
    /**
    * Validate() method override for MJ_BizApps_Issues: Issue Number Sequences entity. This is an auto-generated method that invokes the generated validators for this entity for the following fields:
    * * NextSequenceNumber: The next sequence number must be a positive integer greater than zero to ensure sequence generation starts correctly.
    * @public
    * @method
    * @override
    */
    ...
    /**
    * The next sequence number must be a positive integer greater than zero to ensure sequence generation starts correctly.
...
export class mjBizAppsIssuesIssueEntity extends BaseEntity<mjBizAppsIssuesIssueEntityType> {
    ...
    */
    ...
    /**
    * Validate() method override for MJ_BizApps_Issues: Issues entity. This is an auto-generated method that invokes the generated validators for this entity for the following fields:
    * * Table-Level: Both Assignee Entity and Assignee Record must either be provided together or both left blank to ensure the assignee reference is complete.
    * * Table-Level: Both Source Entity and Source Record must be provided together, or both must be left empty.
    * @public
    * @method
    * @override
    */
    public override Validate(): ValidationResult {
        const result = super.Validate();
        this.ValidateAssigneeFieldsCoexistence(result);
    ...
    /**
    * Both Assignee Entity and Assignee Record must either be provided together or both left blank to ensure the assignee reference is complete.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    public ValidateAssigneeFieldsCoexistence(result: ValidationResult) {
    ...
    /**
    * Both Source Entity and Source Record must be provided together, or both must be left empty.
    * @param result - the ValidationResult object to add any errors or warnings to
    * @public
    * @method
    */
    ...
    * * Description: Predicted probability (0.0000 - 1.0000) that this issue escalates to critical or high back-and-forth severity.
    */
    get PredictedCriticalEscalationProbability(): number | null {
        return this.Get('PredictedCriticalEscalationProbability');
    }
    set PredictedCriticalEscalationProbability(value: number | null) {
        this.Set('PredictedCriticalEscalationProbability', value);
    }
    ...
    * * Description: Operational escalation risk tier: Low (<0.30), Medium (0.30-0.70), High (>0.70), or Critical (>=0.90).
    */
    get PredictedEscalationRiskBand(): 'Critical' | 'High' | 'Low' | 'Medium' | null {
        return this.Get('PredictedEscalationRiskBand');
    }
    set PredictedEscalationRiskBand(value: 'Critical' | 'High' | 'Low' | 'Medium' | null) {
        this.Set('PredictedEscalationRiskBand', value);
    }
    ...
    * * Description: Timestamp when this issue was last scored by the predictive escalation model.
    */
    get PredictedEscalationScoredAt(): Date | null {
        return this.Get('PredictedEscalationScoredAt');
    }
    set PredictedEscalationScoredAt(value: Date | null) {
        this.Set('PredictedEscalationScoredAt', value);
    }
    ...
    * * SQL Data Type: varchar(9)
    */
    get IsCriticalEscalation(): string {
        return this.Get('IsCriticalEscalation');
    }
    ...
    * * SQL Data Type: int
    */
    get HasAssignee(): number {
        return this.Get('HasAssignee');
    }
    ...
    */
    get DescriptionLength(): number {
        return this.Get('DescriptionLength');
    }
}
